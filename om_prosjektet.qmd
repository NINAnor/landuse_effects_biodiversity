...
Dette prosjektet er finansiert av [Norges Forskningsråd](Norges forskningsråd (forskningsradet.no), via en korrdinerings- og støtteaktivitet. Mer informasjon om prosjektet finnes [her](https://prosjektbanken.forskningsradet.no/project/FORISS/338270?Kilde=FORISS&distribution=Ar&chart=bar&calcType=projects&Sprak=no&sortBy=score&sortOrder=desc&resultCount=30&offset=0&Fritekst=arealbruk).
