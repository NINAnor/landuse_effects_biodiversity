...
library(CiteSource)
library(tidyverse)
unique_citations <- readRDS(here:here("landuse_effects_biodiversity/data/unique_citations.RDS"))
...
nor_bib <- readRDS(here::here("landuse_effects_biodiversity/data/cache_data/nor_bib.RDS"))
