...
Før prosjektet ble gjennomført ble det utviklet en detaljert protokoll som beskriver gjennomføringen. Denne protokollen inkluderte en beskrivelse av:
...
I vår søkestrategi benyttet vi oss av PICO-rammeverket (James et al., 2016) for å strukturere søket, og sørge for at det var dekkende for vårt primære forskningsspørsmål. <!--# Missing ref to James et al -->

Følgende søkestreng ble benyttet i WoS (tilsvarende streng ble benyttet i Scopus, men her ble søket justert for å passe Scopus sitt grensesnitt):
...
# #11  47  52  60  61  63  74  75 125 158 217 248
...
# join_Nor_form[248,]$doi<-"10.1016/j.envsci.2022.08.015"
# join_Nor_form[c(74,75,125,158, 217), ]$doi<-NA
# #join_Nor_form[248,]$study_title
# # get openAlexR data
# 
# 
...
### Open data, open code, preregistered, open access
