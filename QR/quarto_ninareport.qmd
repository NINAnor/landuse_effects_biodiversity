...
#| message: false
#| warning: false
#| fig-cap: "Omfang av samfunnsrelatert litteratur som fokuserer på ulike samfunsfaglige tema. Delene av søylene med farger refererer til artikler som har brukt samfunnsvitenskapelige metoder. Rest av syølen (den grå delen) refererer til naturvitenskapelige studier som også har studert de samme temaene."
...
join_Nor_form_soc |>
  ...
  rowwise() |>
  mutate(total = sum(c(Other, Social_Sciences))) |>
  ggplot() +
  geom_histogram(
    aes(
      x = fct_reorder(empirical_focus_of_study, total),
      y = total
    ),
    stat = "identity",
    fill = "grey70"
...
Av den samfunnsvitenskapelige forskningen vi har undersøkt er flest studier relatert til skogøkosystemer, etterfulgt av fjelløkosystemer og semi-naturlige økosystemer. 
...
```{r fig-socialscience-areause_coarse}
#| echo: false
#| message: false
#| warning: false
