...
**Figur X** *Oversikt over kumulativ økning i antall artikler (venstre y-akse, orange sirkler) og antall artkler publisert i de ulike årene i perioden 1986 - 2024.*
...
**Figur X** *Oversikt over forskningen basert forskningskategori.*

Som det framkommer av Figur X er det en stor overvekt over observajonelle studier (Observational studies) i vårt datamateriale. Observasjonelle studier er her definert som studier som baserer seg på empiriske data fra systemet som undersøkes. også konseptuelle arbeider og scenario-modellering er relativt hyppig forkommende.
...
**Figur X** *Oversikt over hvordan forskningen fordeler seg mellom ulike disipliner*.

I vårt materiale er det en stor overvekt av forskning som faller inn under fagdisiplinen matematikk og naturvitenskap (Mathematics and Natural Sciences) (Figur X), men det er også en betydelig andel samfunnsvitenskapelige studier (Social Sciences).
...
**Figur X** *Oversikt over hvilken geografisk målestokk forskningen er gjennomført på*.

Det meste av forskningen er gjennomført på det vi har karakterisert som lokal (f.eks. en del av en kommune) eller regional (f.eks. et fjellområder eller et fylke) (Figur X). En betydelig mindre andel av forskningen dekker hele landet eller er basert på multinasjonale datasett.
...
De hyppigst studerte økosystemene i vårt materiale er skog (Forest) etterfulgt av fjelløkosystemer (Mountains) og semi-naturlige økosystmer (Semi-natural ecosystems) (Figur X). Den siste kategorien er dominert av studier på semi-naturlig engvegetasjon. De øvrige økosystemtypene er langt dårligere representert.
...
**Figur X** *Fordeling av forskningsartikler på ulike fylker i Norge*

Det er en betydelig variasjon i hvor mye av forskningen som er fanget opp i vår litteraturgjennomgang som har vært lokalisert i de ulike fylkene (Figur X). Flest studier er gjennomført i fylkene Innlandet, Trøndelag, Vestland og AKershus, mens det er færrest artikler fra Vetfold, Møre og Romsdal og Troms. I tillegg er det få studier som fokuserer på arealbruk på Svalbard.
...
**Figur X** *Fordeling av forskningsartikler som har studert effekter av de ulike hovedformene for arealbruk*
...
**Figur X** *Antall forskningsartikler som har studert effekten av ulike former for arealbruk eller arealbruksenderinger*

Som det framgår av figurene over (Figur X og Figur X) er det gjennomført studier av en lang rekke ulike former for arealbruk og arealbruksendringer. På et overordnet plan er det effekter av ulike former for landbruk (Agriculture) og utnyttelse av biologiske ressurser (Biological Resource use) som er hyppigst studert. Det er langt færre artikler som omhandler vern (Protection) og restaurering (Restoriation).

Dersom vi bryter ned areabruk og arelabruksenderinger i finere kategorier (ref. [@nilsen2024]), ser man at særlig er effekter av skogbruk (Biological resource use: forestry) og effekter av tamme beitedyr (Agricultrue & aquaculture: outfield resources (including grazing) hyppig studert (Figur X).
...
**Figur X** *Fordeling av ulike taksonomiske nivå i forskningslitteraturen*

Det er en klar overvekt av artikler som fokuserer på (en eller flere) arter i den litteraturen vi har gått gjennom fra Norge (Figur X). Det er også en relativt stor andel av litteraturen som fokuserer på hele riker (Kingdom). Dette er i stor grad snakk om artikler som f.eks. beskriver responsen til hele plantesamfunn på en eller flere former for arealbruk.
