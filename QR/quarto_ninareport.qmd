...
=======
|---------------------|---------------------------------------------------|
>>>>>>> a288e1d1429c922a182bd209cb48f57fd2710847
...
**Figur X** *Fordeling av forskningsartikler hvor de ulike hovedøkosystemene er representert*.
...
n_studies<-unlist(sysRev$number_of_studies_assessed)

n_studies<-data.frame(n_studies)

n_studies$n_studies<-as.numeric(n_studies$n_studies)
n_studies|> 
  ggplot(aes(n_studies))+
