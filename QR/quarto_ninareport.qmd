...
Grunnleggende kunnskap om utbygging, endringer i arealbruksintentisitet og andre konkrete arealendringer er grunnlaget for i neste omgang å vurdere hvilken virkning endringene har for naturmangfold og naturgoder.
...
-   Hvilke samfunnsområder og -sektorer er mest studert?
...
I litteratursøket identifiserte vi 36 418 referanser gjennom databasesøk. Etter fjerning av duplikater sto vi igjen med 20 265 referanser. Disse ble deretter gjennomgått, og 14 808 referanser ble vurdert nærmere. I tillegg ble 1 965 referanser identifisert gjennom andre kilder. Etter videre gjennomgang ble 12 144 referanser ekskludert. 2 398 fulltekstartikler ble vurdert for egnethet. Ingen studier ble inkludert i den kvalitative syntesen. Det var heller ingen fulltekstartikler som ble ekskludert med spesifikke begrunnelser. Til slutt ble ingen studier inkludert i den kvantitative syntesen (meta-analysen)
...
En stor overvekt av forskningen som fanges opp av kunnskapskartet faller inn under fagdisiplinen matematikk og naturvitenskap (*Mathematics and Natural Sciences*) (@fig-dicipline), men det er også en betydelig andel samfunnsvitenskapelige studier (*Social Sciences*).
...
Det er en betydelig variasjon i hvor mye av forskningen som er fanget opp i vår litteraturgjennomgang har vært lokalisert i de ulike fylkene (@fig-fylke). Flest studier er gjennomført i fylkene Innlandet, Trøndelag, Vestland og Akershus, mens det er færrest artikler fra Vestfold, Møre og Romsdal og Troms. I tillegg er det få studier som fokuserer på effektene av arealbruk på Svalbard.
...
Dersom vi bryter ned areabruk og arelabruksenderinger i finere kategorier (ref. [@nilsen2024]), ser vi at effekter av skogbruk (*Biological resource use: forestry*) og tamme beitedyr (*Agricultrue & aquaculture: outfield resources (including grazing*)) er særlig hyppig studert (@fig-landuse-detailed).
...
#### Hvordan er forskningen fordelt på ulike essensielle naturbeskrivelsesvariabler (EBV) {.unnumbered}
...
Blant studier som fokuserte på én eller et fåtall arter var det studier av reinsdyr (*Rangifer tarandus*) som var hyppigst forekommende i vårt datamateriale (@fig-species), mens studier av arealbrukseffekter på gaupe (*Lynx lynx*), elg (*Alces alces*) og laks (*Salmo salar*) kom de neste plassene i frekvenslisten.
...
#### Hva er de vanligste analytiske tilnærmingene i samfunnsvitenskapelige studier?
...
#### Hvem benytter verktøyet i planlegging og forvaltning?
...
I dette kapittelet presenteres resultatene fra gjennomgangen av de systematiske litteraturgjennomgangene som ble fanget opp av vårt søk og som ble vurdert som relevante basert på våre inkluderingskriteriene. I motsetning til primærstudier, hvor vi kun inkluderte artikler fra Norge, var kriteriet for systematiske litteratursammenstillinger at de hadde en global eller , Europeisk eller Fennoskandisk dekning. Narrative oversiktsartikler ble ikke inkludert i vår gjennomgang. Totalt ble `r dim(sysRev)[1]` artikler inkludert.

#### Hvor hyppig er ulike økosystemer og ulike typer arealbruk og arealbruksendringer inkludert i de systematiske litteratursammenstillingene?
...
#### Vurdering av kvaliteten til de systematiske litteraturesammenstillingene
...
Den hyppigst forekommende formen for systematisk litteratursammenstilling i vårt datamateriale er.... (@fig-type-sum-evidence).
...
## Et beslutningsstøtteverktøy basert på norske forskningsartikler

Vi kan vurdere den konseptuelle og tematiske utviklingen av et forskningsfelt ved hjelp av bibliometrisk nettverksanalyse (@cobo2011approach). En slik nettverksanalyse vurderer forholdet mellom nøkkelord i et sett med dokumenter. Analysen hjelper med å identifisere nøkkeltemaer, sammenhengen mellom dem og hvordan de endrer seg over tid. Dette gir verdifull innsikt for forskere og beslutningstakere når man skal prioritere ny forskning.

Basert på metoden beskrevet i @cobo2011approach hentet vi først nøkkelord (*keywords*) fra alle de inkluderte artiklene fra Norge. Vi opprettet deretter en såkalt "Co-Currence Matrix" som teller hvor ofte hvert par med nøkkelord forekommer samtidig i dokumentene. Matrisen for samtidig forekomst ble deretter konvertert til en nettverksgraf, der nøkkelord er "noder" forbundet med linjer som representerer deres samtidige forekomst.

Ved å bruke «walktrap-algoritmen» blir nøkkelord gruppert i klynger. Walktrap-algoritmen er en metode som identifiserer felleskap gjennom å bruker tilfeldige ruter for å utforske nettverket og identifisere klynger av noder som er tettere koblet til hverandre enn til resten av nettverket. Ved å simulere tilfeldige ruter og slå sammen noder basert på deres samtidige forekomstfrekvenser, avslører det effektivt fellesskapsstrukturen i nettverket. Dette gjør det spesielt nyttig for å analysere komplekse nettverk.

Hver klynge representerer et tematisk område innenfor forskningsfeltet (hvor nøkkelord innenfor samme klynge forekommer oftere). Vi benytter to egenskaper til å beskrive sentrale egenskaper ved klyngene: sentralitet og tetthet. Sentraliteten til hvert tema indikerer betydningen av temaet for hele nettverket. Høy sentralitet tilsier at temaer er godt integrert i forskningsfeltet. Sentrale tema fungerer også som broer mellom beslektede tema og regnes ofte som kjerne- eller «mainstream-temaer». Temaer med lav sentralitet er mer isolerte og har færre forbindelser til andre temaer. Dette kan være nye tema eller nisjeområder som ennå ikke er dypt integrert i det bredere forskningsfeltet. Tetthet måler den interne sammenhengen innenfor et tema, og indikerer hvor sterkt nøkkelordene innenfor et bestemt tema er knyttet til hverandre. Det gjenspeiler i hvilken grad et tema er selvstendig eller "modent". Temaer med høy tetthet har sterke interne forbindelser, noe som betyr at nøkkelordene i temaet ofte forekommer sammen med hverandre. Disse temaene er godt utviklet og internt sammenhengende, og representerer ofte spesialiserte forskningsområder. Temaer med lav tetthet har svakere interne forbindelser. Nøkkelordene innenfor disse temaene forekommer ikke like ofte, noe som indikerer at temaet kan være løsere definert, mindre modent og fortsatt i utvikling.
...
-   **Grunnleggende og transverse** tema (høy sentralitet, lav tetthet): Disse temaene er sentrale, men har mindre grad av internt samhold. De fungerer som broer mellom ulike forskingstema og kan dekke en større bredde i forskningen.

-   **Nisjetema** (lav sentralitet, høy tetthet): Disse temaene er spesialiserte og har høy grad av internt samhold, men de er ofte ikke godt integrert i det større forskningsfeltet. De representerer fokuserte (spesialiserte) forskningstema.

-   **Stigende eller dalende tema** (lav sentralitet, lav tetthet): Disse temaene er mindre utviklet. Dette kan være nye temaer på veg opp eller eldre tema som har fått mindre fokus.
...
I @fig-themeMap er temaer indikert med et enkelt felles nøkkelord. Vi kan se at godt studerte temaer i utvalget fra Norge inkluderte artsrikhet (*species richness*) spesielt i sammenheng med skogforvaltning, og rein (*Rangifer tarandus*) – her med fokus på villrein. Studier rundt habitatvalg (*habitat selection*) inkluderte studier på gaupe og rådyr. Konflikt mellom mennesker og dyreliv rundt gjess og jordbruk er også godt studert.
