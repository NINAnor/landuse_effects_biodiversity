...
#| message: false
#| warning: false
#| fig-cap: "Number of Norwegian publications per year"
...
plot_years |> 
ggplot(aes(x = year)) +
  geom_point(aes(y = csum), color = "blue") +
  geom_bar(aes(y = n), stat = "identity", fill = "red", alpha = 0.5) +  # Scale n to fit the secondary axis
  scale_y_continuous(
    name = "Cumulative Sum",
    sec.axis = sec_axis(~., name = "Count (n)")  # Reverse the scaling for the secondary axis
  ) +
  theme(
...
### Hvordan er forskningen fordelt på ulike nivåer av biologisk organisering (arter, taksonomiske nivå, økosystemtjenester osv)?
...
### Hva er de mest studerte typene av arealbruk og arealbruksendringer?
...
### Hvilke regioner i Norge er det gjennomført mest forskning på de aktuelle tema?
...
### Hvor vanlig er det at studiene er basert på åpne data, åpen kildekode og preregistrering av hypoteser?
...
WHICH QUESTION DOES THIS RELATE TO?
